...
func HandleSaveTextMetric(db storage.Storage) http.HandlerFunc {
...
func HandleLoadTextMetric(db storage.Storage) http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		metricName := chi.URLParam(r, "metricName")

		metric, err := db.Get(metricName)
		if err != nil {
